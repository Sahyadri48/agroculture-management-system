	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">BIT College Of Engineering<span></span></p>
			</div>
			<div>
...
<section>
							...
							<form method="post" action="Login/signUp.php">
								...
								<div class="row uniform">
				                        ...
				                        <div class="3u 12u$(small)">
				                            <input type="radio" id="far" name="category" value="1" >
				                            <label for="farmer" onmouseover="click_('far')">Farmer</label>
				                        </div>
				                        <div class="3u 12u$(small)">
				                            <input type="radio" id="buy" name="category" value="0" for="buyer">
				                            <label for="buyer" onmouseover="click_('buy')">Buyer</label>
				                        </div>
