...
<body>
				...
				<section id="main" class="wrapper style1 align-center">
                       ...
                       <input type="input" name="pid" value="<?php echo $pid ?>" hidden>
                       <center><div class="6u 12u$(large)">
                                        <input name="qty" id="qty" placeholder="Quantity">
                         </div></center>
						<div class="12u$">
                            <center>
