				...
				<div class="container">
					...
					<?php
						...
						?>
                            ...
                            <input type="button" value="remove" id= "<?= $ids; ?>" onclick="delete_div(this.id)">
						</section>
						</div>
                        <?php $ids = $ids+1;  ?> 
                    <?php endwhile;	?>
                     <div class="6u 12u$(large)">
                                        <center><a href="buyNow.php?pid=<?= $pid; ?>" class="btn btn-primary" style="text-decoration: none;">Buy Now</a>
	                                    </center></div>
